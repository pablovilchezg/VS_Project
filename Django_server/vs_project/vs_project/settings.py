...
# returns <workspace>/vs_project/tango_
# with_django_project
PROJECT_PATH = os.path.join(SETTINGS_DIR, os.pardir)

# returns <workspace>/vs_project/
PROJECT_PATH = os.path.abspath(PROJECT_PATH)

DATABASE_PATH = os.path.join(PROJECT_PATH, 'vs.db')
...
SECRET_KEY = '6k$8!-i!igybmw@uobj3*n!xm1kw*h8^f(gr(9nm5yj%xkug&#'
...
# returns <workspace>/vs_project/templates
...
DIRECTORY_DIRECTORY = '/home/userpro/Project/Multimedia/'
				   
GEOPOSITION_GOOGLE_MAPS_API_KEY = 'AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA'
